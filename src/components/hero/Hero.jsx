...
import HunzaCV from './HunzaCV.pdf'
    ...
    <div className='relative overflow-hidden min-h-[550px] sm:min-h-[660px] flex flex-col'>
        ...
        className='text-white body-font z-10'>
            <div className='container mx-auto flex px-5 py-24 md:flex-row flex-col items-center'>
                ...
                <h1 className='title-font sm:text-4xl text-4xl mb-4 font-bold text-white'>Hi! I'm <span className=' md:text-orange-500 text-white'>HUNZA</span></h1>
                <p className='mb-8 leading-relaxed'>I have a strong passion for web
                    development, creating
                    user-friendly websites, and solving coding challenges with simple and efficient
                    solutions.Dedicated to writing well-structured, maintainable, and error-free code 
                </p>
                <div className='flex justify-center'>
                    <a href={HunzaCV} download> 
                ...
                <div className='lg:max-w-lg lg:w-full md:w-1/2 w-5/6'>
                   <img src={heroimg} alt="hero" className='object-cover object-center rounded-full w-80 h-80' />
                </div>
            </div>
        </section>
    </div>
