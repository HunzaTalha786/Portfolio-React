...
export default function Language() {
    const languages = [
        {code:'En', name:'English', level:'Well Spoken'},
        {code:'Ur', name:'Urdu', level:'Common'},
        
    ];
  return (
    <section data-aos='fade-up' data-aos-delay='400' className='flex flex-wrap md:flex-nowrap flex-col items-center justify-center gap-10 md:gap-20 h-[300px] text-blue-950 mt-11 '>
        <h2 className='text-4xl font-bold text-center mb-12 text-white'>Languges</h2>
